...
export const Page01: FC = () => {
  return (
    <PageWrapper px={5} pt={5} footer={<EinmalanlageZeichnungsscheinFooter />}>
      <DocumentHeader
        title="Zeichnungsschein"
        compartmentDate="2020-1"
        subtitle="(Zeichnungs- und Begebungsvertrag)"
        note="(Stand: 10. Juni 2020)"
      />
      <Box mb={5}>
        <PrintableText>
          Order-Teilschuldverschreibung der Deutsches Finanzkontor S.A., Handelsregister (Registre de Commerce et des
          Sociétés) Luxemburg, Nr. B227961, handelnd für das Compartment DFK 2020-1.
        </PrintableText>
        <PrintableText my={5}>Empfangsbestätigung</PrintableText>
        <PrintableText>
          Ich habe den Wertpapierprospekt vom 17. Februar 2020 mit dem darin abgedruckten Vertragswerk (insbesondere den
          Anleihebedingungen, den Genussscheinbedingungen und dem Darlehensvertrag) sowie dem beigelegten
          Basisinformationsblatt und der beigelegten Verbraucherinformationen für außerhalb von Geschäftsräumen
      ...
      <Box>
        ...
        <PrintableText mt={5}>
          ...
          Luxemburg, Nr. B227961, handelnd für das Compart-ment DFK 2020-1 (die{' '}
