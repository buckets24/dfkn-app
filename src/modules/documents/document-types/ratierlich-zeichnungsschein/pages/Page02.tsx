...
export const Page02: FC = () => {
  return (
    <PageWrapper px={5} pt={5} className="no-page-break" footer={<RatierlichZeichnungsscheinFooter />}>
      ...
      <PrintableText mb={4}>
        Kontoinhaber: Deutsches Finanzkontor S.A., handelnd für das Compartment DFK 2020-2
      </PrintableText>
      ...
      <PrintableText mb={5}>
        ...
        2020-2, 62, Avenue de la Liberté L-1930 Luxembourg, Großherzogtum Luxemburg, Telefonnr. +352 263778-1, Fax +352
      ...
      <PrintableText mb={5}>
        ...
        Rechtsverhältnisse zwischen der Emittentin Deutsches Finanzkontor S.A., handelnd für das Compartment DFK 2020-2,
