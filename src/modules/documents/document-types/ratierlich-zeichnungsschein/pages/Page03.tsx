...
export const Page03: FC = () => {
  return (
    <PageWrapper mb={5} px={5} pt={5} className="no-page-break" footer={<RatierlichZeichnungsscheinFooter />}>
      <PrintableText mb={5}>
      ...
      <PrintableText mb={5}>
        ...
        S.A. handelnd für das Compartment DFK 2020-2) über die betreffenden personenbezogenen Daten zu verlangen; dies
      ...
      <PrintableText mb={10}>
        Der Widerruf ist zu richten an: Deutsches Finanzkontor S.A., handelnd für das Compartment DFK 2020-2, 62, Avenue
      ...
      <PrintableText>Deutsches Finanzkontor S.A., Compartment DFK 2020-2</PrintableText>
