...
import { EinmalanlageGeldwaeschegesetzFooter } from '../EinmalanlageGeldwaeschegesetzFooter';

export const Page01: FC = () => {
  return (
    <PageWrapper px={5} footer={<EinmalanlageGeldwaeschegesetzFooter />}>
      <DocumentHeader
      ...
      <PrintableField<RadioFieldType>
        ...
        isRequired
      />
      <PrintableText>Bei Vorliegen einer politisch exponierten Person bitte angeben:</PrintableText>
      <FormGridLayout
        mt={3}
        columns={1}
        fields={[
